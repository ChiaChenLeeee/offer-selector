...
export const DEFAULT_DIMENSIONS: Dimension[] = [
  ...
  },
  {
    ...
    active: true,
    options: [
      { label: '955（朝九晚五，一周休2天）', value: '955', score: 100 },
      { label: '965（朝九晚六，一周休2天）', value: '965', score: 90 },
      { label: '975（朝九晚七，一周休2天）', value: '975', score: 70 },
      { label: '996（朝九晚九，一周休1天）', value: '996', score: 40 },
      { label: '007（全天候待命）', value: '007', score: 0 }
    ]
  },
  {
    id: 'jobTitleValue',
