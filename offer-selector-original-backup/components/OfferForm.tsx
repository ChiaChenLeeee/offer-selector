...
import { Trash2, TrendingUp, HelpCircle, Edit3, Calculator, ChevronDown, ChevronUp, AlertCircle, Star } from 'lucide-react';
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1 mr-4">
          ...
          <div className="mt-1">
            ...
            {showFormula && (
              <div className="mt-3 p-3 bg-slate-50 rounded-2xl border border-slate-100 text-[11px] leading-relaxed text-slate-500 animate-in fade-in slide-in-from-top-2 duration-300">
